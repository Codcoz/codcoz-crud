...
<div class="container">
    ...
    <main class="content">
        ...
        <div style="display: flex" class="actions">
            ...
            <form action="<%= request.getContextPath() %>/ServletReadNotaFiscalXml" method="get">
        ...
        <div class="tabela-container">
            <table>
                ...
                <tr>
                    ...
                    <td class="acoes">
                        <a href="<%= request.getContextPath() %>/ServletReadNotaFiscalXml?view=update&id=<%= nota.getId() %>" title="Editar nota fiscal">

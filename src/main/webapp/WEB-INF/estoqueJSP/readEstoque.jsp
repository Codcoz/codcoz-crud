...
<div class="container">
    ...
    <main class="content">
        ...
        <div class="actions">
            ...
            <form action="<%= request.getContextPath() %>/ServletReadEstoque" method="get">
        ...
        <div class="tabela-container">
            <table>
                ...
                <tr>
                    ...
                    <td class="acoes">
                        <a href="<%= request.getContextPath() %>/ServletReadEstoque?view=update&id=<%= estoque.getId() %>" title="Editar estoque">
